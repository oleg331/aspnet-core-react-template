        ...
        return (
            <div id="content">
                <div className="content__container">
                        ...
                        <table className="table">
                            <thead>
                                <tr>
                                    ...
                                    <th>Email</th>
                                    <th>Phone</th>
                                    {AuthService.isSignedIn() ? <th>Editting</th> : ''}
                                </tr>
                            </thead>
                            <tbody>
                                {this.state.contacts.map((contact, index) =>
                                    <tr key={contact.id}>
                                        ...
                                        {AuthService.isSignedIn() ?
                                            <td>
                                                <Link to={RoutePaths.ContactEdit.replace(":id", contact.id.toString())}>edit</Link>
                                                <button type="button" className="btn btn-link" onClick={(e) => this.delete(contact)}>delete</button>
                                            </td> : ''}
                    ...
                    {AuthService.isSignedIn() ? <Link className="btn btn-success" to={RoutePaths.ContactNew}>add</Link> : ''}
                </div>
            </div>
        )
    };
